...
cl-sndfile-swig.lisp: $(SNDFILE_SWIG_INCLUDE) $(SNDFILE_INCLUDE)
	...
	$(Q)sed 's|#x7FFFFFFFFFFFFFFFLL|#x7FFFFFFFFFFFFFFF|' src/cl-sndfile-swig.lisp > src/cl-sndfile-swig.lisp.tmp; \
	mv src/cl-sndfile-swig.lisp.tmp src/cl-sndfile-swig.lisp

$(SNDFILE_SWIG_INCLUDE):
	$(Q)$(ECHO) "Creating include file for swig"
	$(Q)sed 's|__SNDFILE_INCLUDE__|$(SNDFILE_INCLUDE)|' $(SNDFILE_SWIG_INCLUDE).tmpl > $(SNDFILE_SWIG_INCLUDE)
